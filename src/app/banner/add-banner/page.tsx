...
const AddBanner = () => {
  ...
  const onSubmit = (data: z.infer<typeof FormSchema>) => {
    if (bannerImage.length === 0) return setError(true);
  };
  ...
  return (
    <div className="h-[calc(100vh-81px)] ">
      <div className="flex gap-4 items-center ">
        ...
        <h2 className="text_primary mb-0">Add Banner</h2>
      </div>
      ...
      <div className="flex justify-center items-center h-[calc(100%-100px)]">
        <Card className="sm:w-3/4 w-full">
          <CardHeader>
            ...
            <CardDescription>Create banner this project</CardDescription>
          </CardHeader>
          <Form {...form}>
              ...
              <CardContent className="flex flex-col space-y-4">
                ...
                <div className="">
                  ...
                  {bannerImage.length === 0 ? (
                    <ImageUploader onUploadFile={setBannerImage} fileSize={1} />
                  ) : (
                    <PreviewImage
